...
- [low] Per-property indexable pages (SEO for individual listings). 2026-08-26: `/p/<ref>` share stubs now give every listing its own link + rich preview (noindex redirect stubs, RUNBOOK §7); real indexable listing pages still open.
